# Generated by Powerlevel10k configuration wizard on 2020-08-23 at 21:41 EDT.
...
# disconnected, left frame, dark-ornaments, compact, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES=(
      ...
      $'███  ▏' $'███▎ ▏' $'███▍ ▏' $'███▌ ▏' $'███▋ ▏' $'███▊ ▏' $'███▉ ▏' $'████ ▏'
      $'████ ▏' $'████▎▏' $'████▍▏' $'████▌▏' $'████▋▏' $'████▊▏' $'████▉▏' $'█████▏' )
  typeset -g POWERLEVEL9K_BATTERY_LEVEL_BACKGROUND=(red3 darkorange3 darkgoldenrod gold3 yellow3 chartreuse2 mediumspringgreen green3 green3 green4 darkgreen)
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND='028'
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND='226'
  typeset -g POWERLEVEL9K_BATTERY_CHARGED_FOREGROUND='021'
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND='021'
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD=20

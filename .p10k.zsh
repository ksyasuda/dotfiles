# Generated by Powerlevel10k configuration wizard on 2021-10-24 at 22:00 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    # [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta}@${clean}${VCS_STATUS_COMMIT[1,12]}"
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud|gsutil|gcs'
  # Google cloud color.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_CONFIGURATION//\%/%%}@${P9K_GCLOUD_PROJECT_NAME//\%/%%}'
  ...
  typeset -g POWERLEVEL9K_IP_INTERFACE='tailscale.*'
  # Custom icon.
